	...
	return (
		<section className='py-24 bg-surface-container-lowest overflow-hidden'>
			<div className='px-margin-desktop max-w-container-max mx-auto'>
				<div className='grid grid-cols md:grid-cols-2 gap-20 items-center'>
					...
					<div className='space-y-8'>
						<h2 className='font-headline-lg text-headline-lg text-on-background'>The Craft Behind the
							Fusion</h2>
						<p className='font-body-lg text-body-lg text-on-surface-variant'>Every piece in our Modern
							Fusion collection begins in small artisan hubs across West Africa. We preserve century-old
							techniques while providing sustainable livelihoods for master weavers and dyers.</p>
				...
				<div className="glass-card rounded-[3rem] p-16 relative overflow-hidden">
					...
					<div className="relative z-10 max-w-xl mx-auto space-y-8">
						...
						<div className="flex flex-col md:flex-row gap-4">
							<input
								className="flex-1 rounded-xl border-outline-variant bg-surface-bright p-4 focus:ring-2 focus:ring-primary outline-none transition-all"
