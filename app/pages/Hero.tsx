...
const Hero = () => {
	...
	return (
		<header className='relative h-[450px] md:h-[819px] flex items-center overflow-hidden'>
				...
				<div className='w-full md:max-w-4xl lg:space-y-12 md:space-y-8 space-y-6 animate-fade-in-up'>
					...
					<div className='flex flex-wrap gap-3 sm:gap-4 pt-4'>
						<button
							...
							className='bg-gradient-to-r from-[#a43c12] to-[#ff7f50] text-white sm:px-8 px-5 sm:py-4 py-3 rounded-full font-semibold sm:text-title-md text-sm shadow-xl hover:scale-105 transition-transform whitespace-nowrap'>
							Explore Collection
						</button>
						<button className='shimmer-btn glass-panel sm:px-8 px-5 sm:py-4 py-3 rounded-full hover:scale-105 text-semibold text-primary font-semibold hover:bg-white/40 transition-all shadow-xl cursor-pointer whitespace-nowrap'>
							Our Story
						</button>
					</div>
				</div>
