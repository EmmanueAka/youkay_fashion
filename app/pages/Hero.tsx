		...
		<header className='relative w-full h-[85vh] overflow-hidden'>
			...
			<div className='relative z-10 h-full flex flex-col justify-center items-start px-margin-desktop max-w-auto'>
				<div className='md:max-w-4xl max-w-auto lg:space-y-12 md:space-y-8 space-y-8 animate-fade-in-up'>
					...
					<h1 className='text-[30px] sm:text-[60px] font-bold outline-white drop-shadow-xl text-on-background leading-tight'>
						Handmade <span className='gradient-text '>Heritage</span>, <br/> Modern Soul
					</h1>
					<p className='text-sm font-body-lg sm:text-body-lg text-black max-w-lg'>
					...
					<div className='flex gap-4 pt-base'>
						...
						<button className='glass-panel sm:px-8 px-4 sm:py-4 py-2 rounded-full hover:scale-105 text-semibold text-primary font-semibold hover:bg-white/40 transition-all shadow-xl cursor-pointer'>
							Our Story
						</button>
					</div>
				</div>
