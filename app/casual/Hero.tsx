			...
			<div className='relative z-10 sm:px-margin-desktop px-4 max-w-container-max mx-auto w-full'>
				<div className='sm:max-w-xl max-w-lg'>
					...
					<div className='w-70 md:w-full'>
						...
						<p className='sm:flex sm:font-body-lg sm:text-body-lg text-sm text-gray-700 mb-8 leading-relaxed'>Where relaxed comfort meets ancestral artistry. Discover modern separates and effortless tunics designed for the contemporary lifestyle, featuring subtle West African textile motifs.</p>
					</div>
